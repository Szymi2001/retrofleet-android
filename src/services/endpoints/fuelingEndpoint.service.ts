...
export class FuelingService {
  ...
  async addFueling(newFueling: any): Promise<any> {
    try {
      const response = await axios.post(
        `${this.baseUrl}/fueling/addFueling`,
        newFueling
      );
  ...
  async getFueling(carId: string): Promise<any[]> {
    try {
      const response = await axios.get(
        `${this.baseUrl}/fueling/getFueling/${carId}`
      );
      return response.data;
    } catch (error) {
      this.handleError(error);
  ...
  async getFuelings(userId: any): Promise<any[]> {
    try {
      const response = await axios.get(
        `${this.baseUrl}/fueling/getFuelings/${userId}`
      );
      return response.data;
    } catch (error) {
      this.handleError(error);
